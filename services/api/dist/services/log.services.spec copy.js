...
describe('LogService', () => {
    ...
    beforeAll(async () => {
        const module = await testing_1.Test.createTestingModule({
            providers: [
                ...
                {
                    provide: log_repository_1.LogRepository,
    ...
    describe('When update log', () => {
        it('should update a log', async () => {
            ...
            mockRepository.getById.mockReturnValue(log);
            mockRepository.updateLog.mockReturnValue(Object.assign(Object.assign({}, log), updatedLog));
            mockRepository.createLog.mockReturnValue(Object.assign(Object.assign({}, log), updatedLog));
            const resultlog = await service.updatelog('60903cae3b2367bd1f449a46', Object.assign(Object.assign({}, log), { name: 'Updated Name' }));
...
//# sourceMappingURL=log.services.spec%20copy.js.map